...
export default function Experience() {
  ...
  return (
    <section id="experience" className="bg-black relative text-white ">
      <div
        ref={sceneRef}
          ...
          <div className="flex flex-1 items-center justify-center px-6 pb-10">
            ...
            {isMobile && (
              <div className="relative w-full max-w-md">
                <div className="absolute  left-0 top-0 w-1.5 bg-white/15 rounded h-full">
                  <motion.div
                    className="absolute top-0 left-0 w-1.5 bg-white rounded origin-top"
                    style={{ height: lineSize }}
                  ></motion.div>
                </div>
                  <div className="relative flex flex-col gap-40 ml-10 mt-6 pb-28">
                    {experiences.map((exp, i) => (
                      <ExperienceItem
                        key={i}
                        exp={exp}
