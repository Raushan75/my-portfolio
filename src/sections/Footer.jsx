...
const socials = [
  ...
  //   Icons: FaXTwitter,
  //   label: "X",
  //   href: "https://twitter.com/iamshubhamsingh",
  // },
  {
    Icons: FaLinkedin,
    label: "LinkedIn",
  ...
  return (
    <footer className="relative overflow-hidden bg-black">
      ...
      <motion.div
        ...
        className="relative z-10 px-4 sm:px-8 lg:10 py-16 md:py-20 flex flex-col items-center text-center space-y-6"
      >
        <h1
        ...
        <div className="h-[3px] w-24 md:w-32 rounded-full bg-linear-to-r from-[#0d558cc] via-cyan-300 to-emerald-4" />
